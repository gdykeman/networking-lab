...
be viewed in ```~/lightbulb/lessons/lab_inventory/{{studentX}}-instances.txt```.  (And yes, I *suppose* you could copy the file, but we'd rather you type it in so you can
